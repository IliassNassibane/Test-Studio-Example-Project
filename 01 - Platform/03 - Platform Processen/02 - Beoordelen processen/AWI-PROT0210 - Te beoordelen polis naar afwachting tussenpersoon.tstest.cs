...
{
    public class AWI_PROT0210___Te_beoordelen_polis_naar_afwachting_tussenpersoon : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Voer een polisnummer in het 'Polisnummer'-veld...")]
        public void SetPolisNummerMetOpgeslagenOmschrijving()
        {
            string omschrijvingStringWaarde = ((string)(System.Convert.ChangeType(Data["BeoordelenTaak_OmschrijvingWaarde"], typeof(string))));
            string polisNummer = omschrijvingStringWaarde.Substring(16, (omschrijvingStringWaarde.IndexOf("(")-41));
            
            Actions.SetText(Pages.InternTestAccept.Relatie_Polissen_PolisnummerFilterVeld, polisNummer);
            
            Pages.InternTestAccept.Relatie_Polissen_PolisnummerFilterVeld.InvokeEvent(ArtOfTest.WebAii.Core.ScriptEventType.OnBlur);
        }
    }
}
